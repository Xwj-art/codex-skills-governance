...
- Google Web.dev, _Core Web Vitals_ (2024 update) — official thresholds.
- Annie Sullivan & Rick Viscomi, _Optimize INP_ (web.dev, 2024).
- Philip Walton, _web-vitals_ JS library (Google) — RUM measurement and attribution.
- Barry Pollard, _Optimizing INP_ and _LCP Sub-parts_ analyses.
- Patrick Meenan, _WebPageTest Cookbook_ — synthetic measurement methodology.
- Addy Osmani, _Speed at Scale_ (HTTP Archive).
